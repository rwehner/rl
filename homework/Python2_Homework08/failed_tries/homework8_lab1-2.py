from tkinter import *
"""Remove all of the code with grid_propagate. This is how it was turned in the first time. The Text widget distorts the geometry."""
class Application(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.frame3label.grid(row=0, column=2, rowspan=1, columnspan=1, sticky=E+W+S+N)
        
        self.frame3entry = Entry(self.frame3)
        self.frame3entry.grid(row=0, column=3, rowspan=1, columnspan=2, sticky=E+W+S+N)  
        
        self.frame3textarea = Text(self.frame3, bg='gray75')
        self.frame3textarea.grid(row=1, column=2, rowspan=11, columnspan=3, sticky=E+W+S+N)
